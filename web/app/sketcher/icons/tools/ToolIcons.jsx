...
import bsplineCVContent from "./bspline-cv.svg";
import bsplineInterpolateContent from "./bspline-interpolate.svg";
...
export function BSplineCVIcon(props) {
  return <SvgIcon content={bsplineCVContent} {...props} />;
}

export function BSplineInterpolateIcon(props) {
  return <SvgIcon content={bsplineInterpolateContent} {...props} />;
}
